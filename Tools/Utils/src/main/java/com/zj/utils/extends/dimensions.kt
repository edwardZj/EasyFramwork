...
val androidx.fragment.app.Fragment.screenWidth
    get() = activity?.screenWidth

val androidx.fragment.app.Fragment.screenHeight
    get() = activity?.screenHeight

fun androidx.fragment.app.Fragment.dip2px(value: Int): Int = activity?.dip2px(value) ?: 0
fun androidx.fragment.app.Fragment.dip2px(value: Float): Int = activity?.dip2px(value) ?: 0

fun androidx.fragment.app.Fragment.sp2px(value: Int): Int = activity?.sp2px(value) ?: 0
fun androidx.fragment.app.Fragment.sp2px(value: Float): Int = activity?.sp2px(value) ?: 0

fun androidx.fragment.app.Fragment.px2dip(px: Int): Float = activity?.px2dip(px) ?: 0f
fun androidx.fragment.app.Fragment.px2sp(px: Int): Float = activity?.px2sp(px) ?: 0f

fun androidx.fragment.app.Fragment.dimen2px(@DimenRes resource: Int): Int = activity?.dimen2px(resource)
        ?: 0
