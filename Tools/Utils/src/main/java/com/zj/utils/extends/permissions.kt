...
fun androidx.fragment.app.Fragment.isPermissionGranted(permission: String): Boolean = activity?.isPermissionGranted(permission) ?: true

fun androidx.fragment.app.Fragment.arePermissionGranted(vararg permissions: String): Boolean = activity?.arePermissionGranted(*permissions) ?: true

fun androidx.fragment.app.Fragment.isPermissionAlwaysDenied(permission: String): Boolean = activity?.isPermissionAlwaysDenied(permission) ?: true

fun androidx.fragment.app.Fragment.arePermissionAlwaysDenied(vararg permissions: String): Boolean = activity?.arePermissionAlwaysDenied(*permissions) ?: true

fun androidx.fragment.app.Fragment.requestPermission(permissions: Array<out String>, requestCode: Int) = activity?.requestPermission(permissions, requestCode)

inline fun androidx.fragment.app.Fragment.requestPermissionWithRationale(permissions: Array<out String>, requestCode: Int, rationale: ((permissions: Array<out String>) -> Unit)) =
        activity?.requestPermissionWithRationale(permissions, requestCode, rationale)
