...
val androidx.fragment.app.Fragment.networkInfo: NetworkInfo?
    get() = activity?.networkInfo

val androidx.fragment.app.Fragment.isNetworkConnected: Boolean
    get() = activity?.isNetworkConnected ?: false

var androidx.fragment.app.Fragment.isWifiEnable: Boolean
    get() = activity?.isWifiEnable ?: false
    set(value) {
        activity?.isWifiEnable = value
    }

val androidx.fragment.app.Fragment.isWifiConnected: Boolean
    get() = activity?.isWifiConnected ?: false

val androidx.fragment.app.Fragment.isMobileConnected: Boolean
    get() = activity?.isMobileConnected ?: false

val androidx.fragment.app.Fragment.networkOperatorName: String?
    get() = activity?.networkOperatorName

val androidx.fragment.app.Fragment.networkType: NetworkType
    get() = activity?.networkType ?: NetworkType.NETWORK_NO
