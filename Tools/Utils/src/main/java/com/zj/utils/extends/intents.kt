 ...
 * @param extras Nullable
 */
inline fun <reified T : Activity> androidx.fragment.app.Fragment.startActivity(extras: Bundle? = null) {
    startActivity(activity?.createIntent<T>(extras))
}
 ...
 * @param requestCode
 */
inline fun <reified T : Activity> androidx.fragment.app.Fragment.startActivityForResult(extras: Bundle? = null, requestCode: Int) {
    startActivityForResult(activity?.createIntent<T>(extras), requestCode)
}
