...
//            .init()
        ...
        Image.with(this).load("https://cdn2.jianshu.io/assets/default_avatar/15-a7ac401939dd4df837e3bbf82abaa2a8.jpg")
            .into(binding.iv3)

        lifecycleScope.launchWhenCreated {
            val img=RxHttp.get("https://cdn2.jianshu.io/assets/default_avatar/15-a7ac401939dd4df837e3bbf82abaa2a8.jpg")
                .toBitmap()
//                .toResponse<Demo1>()
//                .life(this)
                .await()
